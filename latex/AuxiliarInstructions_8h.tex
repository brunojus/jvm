...
\begin{center}
\leavevmode
\includegraphics[width=341pt]{AuxiliarInstructions_8h__dep__incl}
\end{center}
\end{figure}
\subsection*{Funções}
...
\begin{DoxyCompactList}\small\item\em Fun��o que calcula a divisao de dois floats. \end{DoxyCompactList}\end{DoxyCompactItemize}
